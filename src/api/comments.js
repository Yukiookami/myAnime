...
const CQL = {
  ...
  SET_COMMENTS_NUM: "update ArticleDb set comments = op('Increment', {'amount': 1}) where objectId = '{{articleId}}'",
...
export default {
  ...
  setCommentsNum({articleId}) {
    return request(CQL.SET_COMMENTS_NUM, {articleId}, '更新评论数失败')
  },
